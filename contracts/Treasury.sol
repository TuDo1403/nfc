...
// import "./libraries/BitMapLite.sol";
...
//     using BitMapLite for BitMapLite.BitMap;
...
//     uint256 private _withdrawThreshold;

//     BitMapLite.BitMap private _approvals;
//     BitMapLite.BitMap private _acceptedPayments;
...
//         _onlyEOA(to);
//         _checkLock(to);
//         uint256 _to = to.fillLast96Bits();
//         if (_approvals.get(_to)) revert Treasury__PendingRequest();
//         if (amount_ > _withdrawThreshold) {
//             emit LargeWithdrawalRequest(to, amount_);
//             _approvals.set(_to);
//             return;
//         }
...
//     function approveRequest(address receiver_, uint256 amount_)
//         external
//         onlyRole(TREASURER_ROLE)
//     {
//         _safeNativeTransfer(receiver_, amount_);
//         _approvals.unset(receiver_.fillLast96Bits());
//     }
